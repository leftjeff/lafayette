...
export const metadata: Metadata = {
	title: "Get Involved",
	description:
		"Volunteer at cleanup days, become a member, or make a tax-deductible donation to Friends of Lafayette-Pointer Park in Chevy Chase, DC.",
...
export default function GetInvolvedPage() {
	return (
		<div>
			<BreadcrumbJsonLd
				crumbs={[{ name: "Get Involved", href: "/get-involved" }]}
			/>
			<PageHeader
			...
			<Section className="grid gap-6 py-14 lg:grid-cols-3">
				...
				>
					<p>
						...
						in the gardens or on other projects. Students can also earn service
						hours.
					</p>
					<p>
					...
					<p>
						No experience needed. Bring water and sunscreen. Coffee and pastries
				...
				>
					<p>
						...
						donations for plantings, supplies, bench and table replacements, and
						the occasional bigger project like groundskeeping and maintenance
						work.
					</p>
