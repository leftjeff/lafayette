...
export default function AboutPage() {
	return (
		<div>
			<BreadcrumbJsonLd crumbs={[{ name: "About", href: "/about" }]} />
			<PageHeader
				eyebrow="About"
				...
				<article className="space-y-10">
					<Block title="Mission">
						<p>
							...
							gathering places in good repair, and to draw the neighborhood into
							the work of stewardship. We do what city budgets alone cannot —
							the small, steady investments that make a public space feel cared
							for.
						</p>
					</Block>
					...
					<Block title="The land's history">
						<p>
							...
							owned by Horace Jones; part was owned by African-American families
							descended from George Pointer (1773–1862), who was born enslaved,
							gained his freedom, and worked as an engineer on the Chesapeake &
							Ohio Canal. His descendants lived on this land through the 19th
						...
						<p>
							...
							District renamed it Lafayette-Pointer Park — restoring the Pointer
							family&apos;s name to the place where their lives unfolded.
						</p>
					</Block>
					...
					<Block title="What we do">
						<p>
							...
							resurface the tennis courts, plant new trees, and put on community
